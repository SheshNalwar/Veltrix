...
export default function Orb({
  ...
  width = 800, // Add width prop
  height = 800 // Add height prop
}) {
  ...
  useEffect(() => {
    ...
    function resize() {
      ...
      renderer.setSize(width * dpr, height * dpr); // Use width and height props
    ...
    <style>
      {`
        .orb-container {
          position: relative;
          z-index: 2;
          margin: 0 auto; /* Center the orb horizontally */
        }
      `}
    </style>
  </div>;
